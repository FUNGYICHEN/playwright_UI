...
const constantsPath = path.resolve(__dirname, './Q1constants.js');

async function setupQ1() {
    ...
    try {
        await page.goto("https://wap-q1-npf2.qit1.net/login");
...
module.exports = {
    ...
    userRecordValue: '${userRecordValue}'
            ...
            console.log('Q1constants.js has been updated');
        } else {
