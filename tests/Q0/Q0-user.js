...
const constantsPath = path.resolve(__dirname, './Q0constants.js');

async function setupQ0() {
    ...
    try {
        await page.goto("https://wap-q0-npf2.qit1.net/login");
...
module.exports = {
    ...
    userRecordValue: '${userRecordValue}'
            ...
            console.log('Q0constants.js has been updated');
        } else {
