...
const constantsPath = path.resolve(__dirname, './SGconstants.js');

async function setupSG() {
    ...
    try {
        await page.goto("https://wap-sg.qbpink01.com/login");
...
module.exports = {
    ...
    userRecordValue: '${userRecordValue}'
            ...
            console.log('SGconstants.js has been updated');
        } else {
